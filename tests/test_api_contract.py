...
def test_experiment_job_catalog_is_the_narrow_whitelist(client):
    ...
    # news_benchmark added 2026-08-08 (Provider Benchmark & Data Quality
    # Lab Phase 2): same one-subprocess-per-run model (see
    # execution/routes/news_benchmark.py) — full argv built per-request
    # there, not user-shaped.
    # macro_benchmark added 2026-08-XX (Provider Benchmark & Data Quality
    # Lab Phase 3): same one-subprocess-per-run model (see
    # execution/routes/macro_benchmark.py) — full argv built per-request
    # there, not user-shaped.
    # analytics_benchmark added 2026-08-XX (Provider Benchmark & Data
    # Quality Lab Phase 4): same one-subprocess-per-run model (see
    # execution/routes/analytics_benchmark.py) — full argv built
    # per-request there, not user-shaped.
    # engine_benchmark added 2026-08-09 (Engine Benchmark): same
    # one-subprocess-per-run model (see execution/routes/
